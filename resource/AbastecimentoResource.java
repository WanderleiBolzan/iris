package com.iris.teste.transporte.resource;
...
import com.iris.teste.transporte.service.AbastecimentoService;
...
public class AbastecimentoResource {
	...
	@PostMapping
	public ResponseEntity<Abastecimento> insert(@RequestBody Abastecimento obj){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Abastecimento> update(@PathVariable Long id, @RequestBody Abastecimento obj) {
